...
/**
 * 
 * Contains methods for calling math function on the default value which it hold. 
 * Returns that value when propmted. Lets the code calculate and hold said calcuation.
 * @author A.J. Trimble
 *
 */
public class BFCalculator {
    BigFraction defaultValue = new BigFraction(0, 0);
